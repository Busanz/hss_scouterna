      ...
      <div className="relative flex flex-col w-full max-w-360 h-full pb-5 md:pb-10 rounded-sm text-text-primary bg-primary">
        ...
        >
          <Image
            ...
            width={10}
            height={10}
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 object-contain shrink-0 pb-3"
          />
          <h1 className="text-center text-2xl sm:text-3xl lg:text-4xl mt-8 text-text-primary px-1 py-5 md:py-10">
            {t('title')}
          </h1>
