export const departmentsIntro = [
  {
    ...
    moreDetails: {
      ...
      description:
        'För spårare finns det fyra deltagandemärken. Du får ett märke efter att du varit med i Scouterna en viss tid, till exempel en termin. Under terminen har du och dina kompisar lärt er saker som finns beskrivna i målspåren och ni har jobbat efter scoutmetoden. Precis som ett märke från ett läger blir ett deltagandemärke ett minne av upplevelserna patrullen haft tillsammans.',
  ...
  },
  {
    ...
    moreDetails: {
      title: 'Deltagandemärken för Spårarscouter',
      description:
        'Det finns sex deltagandemärken för upptäckare och det är upp till avdelningen att bestämma vilket märke som delas ut när. Det spelar ingen roll i vilken ordning ni använder dem, men bestäm inför varje termin vilket ni kommer att jobba med. De som vill kan bygga vidare på namnet eller temat för respektive märke under terminen, men det går lika bra att inte göra det. Oavsett hur ni gör kommer ni att koppla era minnen till respektive märke.',
      image: '/img/departments/intro-more/badge_kaparna.png',
    },
  },
  {
    id: 2,
    ...
    moreDetails: {
      title: 'Deltagandemärken för Spårarscouter',
      description:
        'Äventyren planeras och genomförs i patrullen utifrån era intressen och möjligheter. I Äventyrarnas handbok samt på Scouternas hemsida finns beskrivningar och idéer om vad de olika äventyrens märken kan innebära.',
      image: '/img/departments/intro-more/badge_konvojen.png',
    },
  },
  {
    id: 3,
    ...
    moreDetails: {
      title: 'Deltagandemärken för Spårarscouter',
      description:
        'Utmanarnas deltagandemärken, Utmaningarna, är större projekt som ni i patrullen planerar och genomför tillsammans för att utmana er själva eller er omgivning. Boken Våga utmana ger tips och råd. Här är några exempel på vad ni kan utmana er med!',
      image: '/img/departments/intro-more/badge_utmanare.png',
    },
  },
  {
    id: 4,
