...
const CourseTrygga = () => {
  return (
    <section className="flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-14 my-5">
      ...
      <div className="w-full lg:w-1/2 order-2 lg:order-2 px-4 md:px-0">
        ...
        <a className="inline-block my-5 px-4 py-2 w-fit rounded-sm text-white bg-primary hover:bg-secondary hover:text-primary"
