...
const CourseHss = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-14 my-5 sm:my-10 md:my-20">
      <div className="w-full order-2 lg:order-1 px-4 md:px-0 flex flex-col">
    ...
    <div className="w-full order-2 lg:order-2 md:px-0 flex flex-col">
        ...
        <div className="w-full order-1 lg:order-2 mb-8 lg:mb-o">
          <Image
            src="/img/intro-section/for_foraldrar.png"
            alt="Image Scout Leader"
            width={350}
            height={270}
            className="w-full h-auto lg:mb-0 rounded-sm lg:mt-10 object-cover"
          /> 
        </div>           
      </div>
    </section>
